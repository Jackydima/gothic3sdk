...
ME_DEFINE_PROPERTY_TYPE(gCDamageReceiver_PS_Ext, gCDamageReceiver_PS, DiseaseTimeStamp, m_DiseaseTimeStamp)
...
ME_DEFINE_PROPERTY_TYPE(gCDamageReceiver_PS_Ext, gCDamageReceiver_PS, LastHealthDamage, m_LastHealthDamage)

gCDamageReceiver_PS_Ext::gCDamageReceiver_PS_Ext(void) : m_PoisonDamage(4), m_DiseaseTimeStamp(0.0f), m_LastBlockTimeStamp(0), m_PerfectBlockDelayed(0), m_LastStaminaUsage(0), m_LastHealthDamage(0)
{}
