...
void HookCallHooks ( ) {
	...
	Hook_AssureProjectiles
		.Prepare ( RVA_ScriptGame ( 0x192a2 ) , &AssureProjectiles , mCBaseHook::mEHookType_Mixed , mERegisterType::mERegisterType_Ebx )
		.InsertCall ( )
	...
	if ( adjustXPReceive ) {
		Hook_GiveXPPowerlevel
			.Prepare ( RVA_ScriptGame ( 0x4e451 ) , &GiveXPPowerlevel , mCBaseHook::mEHookType_Mixed , mERegisterType::mERegisterType_Eax )
			.InsertCall ( )
